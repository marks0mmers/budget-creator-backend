...
class BudgetService(
    ...
    suspend fun getAllBudgetItemsForUser(username: String) = userService
    ...
    suspend fun createBudgetForUser(budget: BudgetSubmissionView, username: String) = userService
        .getUserByUsername(username)
        .toMono()
        .flatMap {
